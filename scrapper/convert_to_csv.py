...
write_to_csv("kobiety-buty", "Kobiety, 18")
write_to_csv("kobiety-odziez", "Kobiety, 17")
write_to_csv("kobiety-akcesoria", "Kobiety, 19")
write_to_csv("chlopcy-buty", "Dzieci, Buty dla chłopców")
write_to_csv("dziewczynki-buty", "Dzieci, Buty dla dziewczynek")
write_to_csv("dzieci-akcesoria", "Dzieci, 22")
